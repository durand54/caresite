...
$end_year = 2032;
$makeArray = array();
$competitiveMakesOne = $db->get("SELECT * FROM vehicles as v, customsegmentvehicles as csv, customsegments as cs WHERE csv.CustomSegmentID = '$makeID' and csv.CustomSegmentID = cs.CustomSegmentID and v.VehicleID = csv.VehicleID and v.cbgid='$cbgid' and DeleteFlag=0 and ActiveFlag='1' and v.sfcsactive='1' order by v.VehicleName");
...
<div id="make">
<div id="modelYearTop">
<div id="segmentLeftArrow"><img src='/img/leftArrow.jpg' width='35px' /></div>
<div class='segment $makeID2'>$segmentName</div>
