...
$end_year = 2032;
$makeArray = array();
$competitiveMakesOne = $db->get("SELECT * FROM vehicles as v, segment as s WHERE v.segmentid = '$makeID' and v.segmentid = s.segmentid and v.cbgid='$cbgid' and DeleteFlag=0 and ActiveFlag='1' and v.sfcsactive='1' order by v.VehicleName");
